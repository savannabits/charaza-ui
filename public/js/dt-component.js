      ...
      vm.table = $("#".concat(vm.tableId)).DataTable({
        ...
        ajax: {
          ...
          data: function data(d) {
            for (var _i = 0, _Object$entries = Object.entries(vm.ajaxParams); _i < _Object$entries.length; _i++) {
          ...
          beforeSend: function beforeSend(request) {
            if (vm.tenant && vm.tenantHeaderName) {
              request.setRequestHeader("".concat(vm.tenantHeaderName), "".concat(vm.tenant));
            }
          }
        },
        columns: columns,
