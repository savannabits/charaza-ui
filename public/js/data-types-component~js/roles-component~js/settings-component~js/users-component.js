(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/data-types-component~js/roles-component~js/settings-component~js/users-component"],{
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    deleteItem: function deleteItem(e) {
      var vm = this;
      var method = "delete";
      var url = "".concat(vm.form.api_route, "/").concat(vm.form.id);
      vm.submitForm(e, url, method).then(function (res) {
      ...
      return _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                params = _arguments2.length > 1 && _arguments2[1] !== undefined ? _arguments2[1] : null;
                vm = _this3;
                return _context2.abrupt("return", new Promise(function (resolve, reject) {
                  vm.showLoader();
                  axios.get("".concat(vm.form.api_route, "/").concat(id), {
                    params: params || {}
                  }).then(function (res) {
