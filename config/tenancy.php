...
return [
    ...
    'bootstrappers' => [
        ...
        \App\Bootstrappers\SessionBootstrapper::class,
     ...
     */
    'cache' => [
        'tag_base' => env("TENANT_PARAM","tenant"), // This tag_base, followed by the tenant_id, will form a tag that will be applied on each cache call.
    ],
    ...
    'filesystem' => [
         ...
         */
        'suffix_base' => env("TENANT_PARAM","tenant"),
        'disks' => [
            'local',
            'public',
            // 's3',
     ...
     */
    'redis' => [
        'prefix_base' => env("TENANT_PARAM","tenant")."_", // Each key in Redis will be prepended by this prefix_base, followed by the tenant id.
